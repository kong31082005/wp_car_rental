...
class WC_Customer_Email_Verification_Admin {		
	...
	*/
	public function admin_styles( $hook ) {						
		...
		wp_enqueue_style( 'customer_email_verification_styles', woo_customer_email_verification()->plugin_dir_url() . 'assets/css/admin.css', array(), time() );
	...
	public function wc_customer_email_verification_page_callback() { 
		...
		<div class="zorem-layout-cev__header">			
			<h1 class="page_heading">
				<a href="javascript:void(0)"><?php esc_html_e( 'Customer Email Verification', 'customer-email-verification' ); ?></a> 
